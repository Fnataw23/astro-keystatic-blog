...
import { c as createExports } from './chunks/entrypoint_BE96Boxl.mjs';
import { manifest } from './manifest_lzMKnwgx.mjs';
...
const _args = {
    "middlewareSecret": "e10278fb-53b1-47a6-a3e8-f81a15800f63",
